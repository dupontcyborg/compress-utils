/**
 * gzip decompress-only subpath. The co-located .wasm is built with the
 ...
 * of `compress-utils/gzip`; for both directions import that instead.
 */
...
const bindings = /*#__PURE__*/ defineAlgorithm(
    Algorithm.Gzip,
    "gzip",
    new URL("./gzip.wasm", import.meta.url),
);
