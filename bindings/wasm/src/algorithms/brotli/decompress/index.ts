/**
 * brotli decompress-only subpath. The co-located .wasm is built with the
 ...
 * of `compress-utils/brotli`; for both directions import that instead.
 */
...
const bindings = /*#__PURE__*/ defineAlgorithm(
    Algorithm.Brotli,
    "brotli",
    new URL("./brotli.wasm", import.meta.url),
);
